...
geth --datadir=$datadir --password /tmp/geth_password account import gethPrivateKey1.txt
geth --datadir=$datadir --password /tmp/geth_password account import gethPrivateKey2.txt
geth --datadir=$datadir --password /tmp/geth_password account import gethPrivateKey3.txt
geth --datadir=$datadir --password /tmp/geth_password account import gethPrivateKey4.txt
